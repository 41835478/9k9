...
<div class="head">
	...
	<h1><a title="{:C('ftx_site_name')}" href="{:C('ftx_site_url')}"><img src="{:C('ftx_site_logo')}" height="45" /></a></h1>		
		<span class="esby"><img src="{:C('ftx_site_flogo')}"></span>
		...
		<div class="top-nav {:C('ftx_site_width')}">
			...
			<div id="userlogin" style="display:block">
				<p class="other-links fr">
				 <span><a href="{:C('ftx_headerm_html')}" target="_blank">手机版</a></span>
